...
assert(INITIAL_MEMORY == 20971520, 'Detected runtime INITIAL_MEMORY setting.  Use -s IMPORTED_MEMORY to define wasmMemory dynamically');
...
var wasmBinaryFile;
  wasmBinaryFile = 'wasm_forweb.wasm';
