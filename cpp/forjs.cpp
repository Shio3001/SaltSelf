...
EMSCRIPTEN_BINDINGS(forjs)
{
    ...
    class_<VertexControl>("VertexControl")
        ...
        .function("CameraCoordinates", &VertexControl::CameraCoordinates)
        .function("CameraDirection", &VertexControl::CameraDirection)
        .function("NewViewPx", &VertexControl::NewViewPx)
        .function("DeleteViewPx", &VertexControl::DeleteViewPx)
        .function("GetView", &VertexControl::GetView, allow_raw_pointers())
